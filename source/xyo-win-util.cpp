...
namespace XYO {
	namespace Win {
		...
		void Util::SendMessageToAllChildWindowsIE(HWND hParendWnd, UINT MessageId, WPARAM wParam, LPARAM lParam) {
			SMessage sMessage;
		...
		void Util::PostMessageToProcessWindows(UINT MessageId, WPARAM wParam, LPARAM lParam) {
			SMessage sMessage;
			sMessage.MessageId = MessageId;
			sMessage.wParam = wParam;
			sMessage.lParam = lParam;
